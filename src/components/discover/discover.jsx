import coffe from "../../assets/images/stylized-cup-coffee-out-coffee-beans-flat-lay 1.svg";
  ...
  return (
    ...
    >
      <section className="py-20 px-4 sm:px-8 md:px-16" id="dicover">
        <div className=" flex flex-col-reverse md:flex-row items-center md:justify-around gap-8 md:gap-16  ">
          ...
          <div className="w-full md:w-1/2  flex justify-center">
            <img
              src={coffe}
              alt="Stylized cup of coffee with coffee beans"
              loading="lazy"
            />
          </div>
        </div>
